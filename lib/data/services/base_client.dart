...
class   BaseClient {
  ...
  static const int TIME_OUT_DURATION = 300*1000; // in milliseconds
  // GET request
  static get(
    String url, {
    ...
    if (check == true) {
      ...
      try {
        ...
        if (error.response?.statusCode == 401) {
          ...
          if (gttt.Get.currentRoute != AppRoutes.signInScreen) {
            gttt.Get.offAllNamed(AppRoutes.signInScreen);
          }
