...
import '../referral_pending_page/widgets/listmindmap1_item_widget.dart';
import 'controller/referral_pending_controller.dart';
import 'models/listmindmap1_item_model.dart';
import 'models/referral_pending_model.dart';
import 'package:flutter/material.dart';
import 'package:salon_symphony/core/app_export.dart';

// ignore_for_file: must_be_immutable
class ReferralPendingPage extends StatelessWidget {
  ReferralPendingController controller = Get.put(ReferralPendingController());
                ...
                builderDelegate: PagedChildBuilderDelegate<CandidateReferralData>(
                  itemBuilder:(context, item, index)  {
                    return Padding(
                        ...
                        child: Listmindmap1ItemWidget(item)
                    );
                  },
