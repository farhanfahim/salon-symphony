...
class ReferralApprovedController extends GetxController {
  RxList<CandidateReferralData>? approvedData = List<CandidateReferralData>.empty().obs;
  ...
  Future <dynamic> getApprovedReferrals() async{
        ...
        _appPreferences.getAccessToken(prefName: AppPreferences.prefAccessToken).then((value) async {
          ...
          await BaseClient.get(
              ...
              onSuccess: (response) {
                ...
                approvedData!.value = candidateReferralModel.value.data!.data!;
                print(response.data);
                ...
                if (!isNotLastPage) {
                  ...
                  pagingController1.appendLastPage(approvedData!.value);
                } else {
                  currentPage = currentPage + 1;
                  print('New Current Page: $currentPage');
                  pagingController1.appendPage(approvedData!.value, currentPage);
                }
              ...
              queryParameters : {
                ...
                'is_approved': AppConstant.ISAPPROVED,
                'user_id': userID,
