...
class CreateWeeklyGoalScreen extends GetWidget<CreateWeeklyGoalController> {
                              ...
                              child: RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: " Measure key benchmarks like your Retail Per Client Ticket or number of add-on services per week.",
                                      style: TextStyle(
                                        color: ColorConstant.black901,
                                        fontSize: getFontSize(
                                          12,
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()..onTap = () => {
                                        Utils().weeklyExample(context,'Weekly Goal Examples'),
                                      },
                                      style: TextStyle(
                                  ...
                                  Obx(() => Flexible(
                                    child: CustomTextField3(
                                      ...
                                      icon:   controller.itemNumber ==
                                          1
                                          ?
                                      ImageConstant.percantage_Icon: null,
                                      prefixWidget: controller.showLogo.value && controller.itemNumber != 1 ?
                                      Container(
                                          height: 30,
                                          width: 30.00,
                                          margin: getMargin(
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                    ...
                                                    child: Padding(
                                                        ...
                                                        child:
                                                        controller.itemNumber == 0 ?
                                                        CommonImageView(
                                                            svgPath: ImageConstant
                                                                .imgLock14X14,
                                                            height: getSize(20.00),
                                                            width: getSize(20.00)) :
                                                        controller.itemNumber == 1
                                                            ? null :
                                                        CommonImageView(
  ...
  void selectDay(context) {
    ...
    HelperFunction.showBottomSheet(
      context,
      bottomSheetHeight:responsive.setHeight(58),
          ...
          return Column(
            children: [
              GestureDetector(
                ...
                child: Container(
                  padding: EdgeInsets.only(bottom: responsive.setHeight(1),right: 20,top: responsive.setHeight(0.5)),
                  child: Row(
                    children: [
  ...
  void selectTargetType(context) {
    ...
    HelperFunction.showBottomSheet(
      context,
      bottomSheetHeight: responsive.setHeight(35),
      isPadding: true,
