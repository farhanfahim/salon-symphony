...
import 'controller/request_pending_controller.dart';
import 'package:flutter/material.dart';
import 'package:salon_symphony/core/app_export.dart';

// ignore_for_file: must_be_immutable
class RequestPendingPage extends StatelessWidget {
  RequestPendingController controller = Get.put(RequestPendingController());
                      ...
                      Expandable_tile(
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return
                                controller.arrOfTimeRequest.value.length>0?
                                RequestAllItemWidget(
                                controller.arrOfTimeRequest[index],
                                onTap: () {
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"pending",'status':10,"requestId":controller.arrOfTimeRequest[index].id});
                                },
                                index: index,
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return   controller.arrOfEducationRequest.value.length>0?RequestAllItemWidget(
                                ...
                                onTap: () {
                                  print("asdasd");
                                  print("${controller.arrOfEducationRequest[index].id}");
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"pending",'status':20,"requestId":controller.arrOfEducationRequest[index].id});
                                },
                                index: index,
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return  controller.arrOfScheduleRequest.value.length>0? RequestAllItemWidget(
                                ...
                                onTap: () {
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"pending",'status':30,"requestId":controller.arrOfScheduleRequest[index].id});
                                },
                                index: index,
