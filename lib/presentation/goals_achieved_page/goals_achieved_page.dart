...
import 'controller/goals_achieved_controller.dart';
...
class GoalsAchievedPage extends StatelessWidget {
  GoalsAchievedController controller = Get.put(GoalsAchievedController());
  @override
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GoalsAllItemWidget(
                                        ...
                                        onTap: () {
                                          Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.ACHIEVED,"requestId":controller.arrOfWeekly[index].id,"userStatusId":controller.arrOfWeekly[index].userStatus!.id});
                                        },
                                        index: index,
                                      ),
                                    ),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      GoalsAllItemWidget(
                                        ...
                                        onTap: () {
                                          Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.ACHIEVED,"requestId":controller.arrOfMonthly[index].id,"userStatusId":controller.arrOfMonthly[index].userStatus!.id});
                                        },
                                        index: index,
                                      ),
                                    ),
                                  ...
                                  children: [
                                    Padding(
                                        ...
                                        GoalsAllItemWidget(
                                          ...
                                          onTap: () {
                                            Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.ACHIEVED,"requestId":controller.arrOfAnnual[index].id,"userStatusId":controller.arrOfAnnual[index].userStatus!.id});
                                          },
                                          index: index,
                                        )
                                    ),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child:GoalsAllItemWidget(
                                        ...
                                        onTap: () {
                                          Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.ACHIEVED,"requestId":controller.arrOfCustom[index].id,"userStatusId":controller.arrOfCustom[index].userStatus!.id});
                                        },
                                        index: index,
                                      ),
                                    ),
