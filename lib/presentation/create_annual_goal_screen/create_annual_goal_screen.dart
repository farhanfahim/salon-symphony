...
class CreateAnnualGoalScreen extends GetWidget<CreateAnnualGoalController> {
                    ...
                    Form(
                      ...
                      child: Column(
                          ...
                          children: [
                              ...
                              child: RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: "Annual goals automatically begin January 1st of the current year and end on December 31st. ",
                                      style: TextStyle(
                                        color: ColorConstant.black901,
                                        fontSize: getFontSize(
                                          12,
                                    ...
                                    TextSpan(
                                      ...
                                      recognizer: TapGestureRecognizer()..onTap = () => {
                                        Utils().weeklyExample(context,'Annual Goal Examples'),
                                      },
                                      style: TextStyle(
                            ...
                            CustomTextField3(
                              fieldText: "How will you achieve this goal?",
