...
class GoalsMissedPage extends StatelessWidget {
  GoalsMissedController controller = Get.put(GoalsMissedController());
  @override
                      ...
                      Expandable_tile(
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return    controller.arrOfWeekly.value.length>0?
                              Column(
                                children: [
                                  Padding(
                                    ...
                                    child: GoalsAllItemWidget(
                                      ...
                                      onTap: () {
                                        Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.MISSED,"requestId":controller.arrOfWeekly[index].id,"userStatusId":controller.arrOfWeekly[index].userStatus!.id});
                                      },
                                      index: index,
                                    ),
                                  ),
                                  controller.arrOfWeekly.length - 1 != index ?
                                  Padding(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: GoalsAllItemWidget(
                                        ...
                                        onTap: () {
                                          Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.MISSED,"requestId":controller.arrOfMonthly[index].id,"userStatusId":controller.arrOfMonthly[index].userStatus!.id});
                                        },
                                        index: index,
                                      ),
                                    ),
                                    controller.arrOfMonthly.length - 1 != index ?
                                    Padding(
                                      padding: const EdgeInsets.only(left: 15.0 ,top: 10,bottom: 10),
                                      child: Container(
                                        height: 1,
                      ...
                      Expandable_tile(
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return controller.arrOfAnnual.value.length>0?
                              Column(
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                    ...
                                    child: GoalsAllItemWidget(
                                      ...
                                      onTap: () {
                                        Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.MISSED,"requestId":controller.arrOfAnnual[index].id,"userStatusId":controller.arrOfAnnual[index].userStatus!.id});
                                      },
                                      index: index,
                                    ),
                                  ),
                                  controller.arrOfAnnual.length - 1 != index ?
                                  Padding(
                                    padding: const EdgeInsets.only(left: 15.0 ,top: 10,bottom: 10),
                                    child: Container(
                                      height: 1,
                      ...
                      Expandable_tile(
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return
                                controller.arrOfCustom.value.length>0?Column(
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.symmetric(
                                          horizontal: 5.0),
                                      child: GoalsAllItemWidget(
                                        ...
                                        onTap: () {
                                          Get.toNamed(AppRoutes.goalDetailsActiveScreen,arguments: {'type':AppConstant.MISSED,"requestId":controller.arrOfCustom[index].id,"userStatusId":controller.arrOfCustom[index].userStatus!.id});
                                        },
                                        index: index,
                                      ),
                                    ),
                                    controller.arrOfCustom.length - 1 != index ?
                                    Padding(
                                      padding: const EdgeInsets.only(left: 15.0 ,top: 10,bottom: 10),
                                      child: Container(
                                        height: 1,
