...
import 'controller/request_declined_controller.dart';
import 'package:flutter/material.dart';
import 'package:salon_symphony/core/app_export.dart';

// ignore_for_file: must_be_immutable
class RequestDeclinedPage extends StatelessWidget {
  RequestDeclinedController controller = Get.put(RequestDeclinedController());
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return controller.arrOfTimeRequest.value.length>0?RequestAllItemWidget(
                                ...
                                onTap: () {
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"decline",'status':10,"requestId":controller.arrOfTimeRequest[index].id});
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return   controller.arrOfEducationRequest.value.length>0?RequestAllItemWidget(
                                ...
                                onTap: () {
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"decline",'status':20,"requestId":controller.arrOfEducationRequest[index].id});
                        ...
                        collapseChild: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return controller.arrOfScheduleRequest.value.length>0? RequestAllItemWidget(
                                ...
                                onTap: () {
                                  Get.toNamed(AppRoutes.requestDetailsTimeOffScreen,arguments: {'type':"decline",'status':30,"requestId":controller.arrOfScheduleRequest[index].id});
