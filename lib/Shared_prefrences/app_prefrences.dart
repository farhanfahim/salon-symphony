...
class AppPreferences {
  ...
  static const String prefSalonId = "SALON_ID";
  static const String prefHireDate = "HIRE_DATE";
  ...
  void setSalonId({required String salonId}) => _setPreference(
      prefName: prefSalonId, prefValue: salonId, prefType: prefTypeString);

  void setHireDate({required String hireDate}) => _setPreference(
      prefName: prefSalonId, prefValue: hireDate, prefType: prefTypeString);

  Future<String> getUserId() async =>
      await _getPreference(prefName: prefUserId);

  Future<String> getSalonId() async =>
      await _getPreference(prefName: prefSalonId);
